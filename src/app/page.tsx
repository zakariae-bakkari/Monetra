          ...
          >
            <motion.div className="flex flex-col gap-6" variants={itemVariants}>
              ...
              <motion.h1 
                ...
                variants={itemVariants}
              >
                Take Control of Your <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent relative">
                  Financial Future
              ...
              <motion.p 
                ...
                variants={itemVariants}
              >
                Monetra helps you track expenses, visualize spending patterns, and achieve your financial goals with powerful analytics and intuitive tools.
              </motion.p>
              <motion.div 
              ...
              >
                <Link href="/register">
                  <Button size="lg" className="w-full sm:w-auto px-8 text-primary-foreground gap-2 cursor-pointer bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 shadow-md">
                    Get Started — It&apos;s Free
                    <ChevronRight className="h-4 w-4" />
                  </Button>
                </Link>
                <Link href="/login">
                  <Button size="lg" variant="outline" className="w-full sm:w-auto px-8 border-primary/30 text-primary hover:text-white bg-primary/5 hover:bg-primary/15 cursor-pointer">
                    Sign In
                  </Button>
                </Link>
              </motion.div>
              ...
              >
                <div className="flex -space-x-2">
                  {[1, 2, 3, 4].map((i) => (
                    <div key={i} className={`w-7 h-7 rounded-full border-2 border-background bg-accent/20 flex items-center justify-center text-[10px] font-medium`}>
                      {i === 4 ? '+' : ''}
                    </div>
                  ))}
                </div>
        ...
        <div className="container px-4 md:px-6 mx-auto">
          ...
          >
            ...
            <motion.h2 
              ...
              variants={itemVariants}
            >
              Everything You Need for <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Financial Success</span>
            </motion.h2>
            <motion.p 
              className="max-w-[700px] text-muted-foreground text-lg leading-relaxed"
              variants={itemVariants}
            >
              Our comprehensive suite of tools helps you stay organized, make informed decisions, and reach your financial goals faster than ever before.
            </motion.p>
          </motion.div>
        ...
        <div className="container px-4 md:px-6 mx-auto">
          ...
          >
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              Join thousands of users who are taking control of their financial future with Monetra&apos;s intuitive tools.
            </motion.p>
            <motion.div 
            ...
            >
              ...
              >
                ...
                <p className="text-muted-foreground text-center text-sm">Sign up in seconds with just your email address</p>
              </motion.div>
              <motion.div 
              ...
              >
                ...
                <h3 className="text-lg font-semibold mb-3">Set Up Your Wallets</h3>
                <p className="text-muted-foreground text-center text-sm">Add your accounts and track your finances in one place</p>
              </motion.div>
              <motion.div 
              ...
              >
                ...
                <h3 className="text-lg font-semibold mb-3">Analyze & Optimize</h3>
                <p className="text-muted-foreground text-center text-sm">Gain valuable insights into your spending patterns</p>
              </motion.div>
            </motion.div>
            <motion.div variants={itemVariants} className="mt-10">
              <Link href="/register">
                <Button size="lg" className="px-8 py-6 text-lg bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 text-white gap-2 cursor-pointer shadow-md">
        ...
        <div className="container px-4 md:px-6 mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="space-y-3">
              ...
              <p className="text-muted-foreground">Modern financial management for everyone. Simple, powerful, and secure tracking of your finances.</p>
            ...
            <div className="space-y-3">
              <h4 className="font-medium text-sm uppercase tracking-wider text-muted-foreground">Product</h4>
              <ul className="space-y-2">
                <li><Link href="#" className="text-foreground/80 hover:text-primary transition-colors">Features</Link></li>
                <li><Link href="#" className="text-foreground/80 hover:text-primary transition-colors">Pricing</Link></li>
                <li><Link href="#" className="text-foreground/80 hover:text-primary transition-colors">Testimonials</Link></li>
                <li><Link href="#" className="text-foreground/80 hover:text-primary transition-colors">FAQ</Link></li>
              </ul>
            </div>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2">
                <li><Link href="#" className="text-foreground/80 hover:text-primary transition-colors">About</Link></li>
                <li><Link href="#" className="text-foreground/80 hover:text-primary transition-colors">Blog</Link></li>
                <li><Link href="#" className="text-foreground/80 hover:text-primary transition-colors">Careers</Link></li>
                <li><Link href="#" className="text-foreground/80 hover:text-primary transition-colors">Contact</Link></li>
              </ul>
            </div>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="#" className="text-foreground/80 hover:text-primary transition-colors">Cookie Policy</Link></li>
                <li><Link href="#" className="text-foreground/80 hover:text-primary transition-colors">Security</Link></li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-border/40 mt-10 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="mt-4 md:mt-0">
              <Link href="/register" className="text-sm px-4 py-2 bg-primary/10 hover:bg-primary/20 text-primary rounded-md transition-colors mr-2">Sign Up</Link>
              <Link href="/login" className="text-sm px-4 py-2 bg-accent/10 hover:bg-accent/20 text-accent rounded-md transition-colors">Sign In</Link>
            </div>
          </div>
        </div>
      </footer>
...
function FeatureCard({ title, description, icon, variants, color = "primary" }: FeatureCardProps) {
  ...
  return (
    <motion.div 
      className={`flex flex-col p-6 bg-card rounded-xl border border-border/40 shadow-sm hover:shadow-md transition-all duration-300 ${getBorderClassName(color)}`}
      variants={variants}
      whileHover={{ y: -5, transition: { duration: 0.2 } }}
    >
      <div className={`mb-5 p-3.5 rounded-lg ${getColorClassName(color)} self-start shadow-sm`}>
        {icon}
      </div>
